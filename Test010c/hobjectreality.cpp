...
QVector3D HItemManagement::getSliderValues (void) {
...
HManagementSlider *HItemManagement::sliderParamsAxis (QString axis) {
    if (axis.contains ("X"))
...
void HItemManagement::setSliderValues (float valX, float valY, float valZ) {
...
void HItemManagement::setSliderValue (QString itemManagement, float val) {
...
void HItemManagement::calculate (QString ) {

}

void HItemManagement::componentComplete() {
