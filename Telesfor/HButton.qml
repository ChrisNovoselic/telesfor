...
BorderImage {
    ...
    onCheckedChanged: {
        console.debug ("HButton::onCheckedChanged (); objectName =", objectName, ", checked =", checkable, checked)
    ...
    MouseArea {
        ...
        onClicked: {
            if ((! edited) && enabled) {
                ...
                console.debug ("HButton::onClicked (); checked =", objectName, checkable, checked)
            }
            else
                ;
        }
...
//                console.debug ("HButton::onDoubleClicked (); edited =", edited)
//            }
//            else
//                ;
...
//            button.doubleClicked ()
        ...
        onPressAndHold:  {
            if (editable) {
                ...
                console.debug ("HButton::onPressAndHold (); edited =", edited)
            }
            else
                ;
...
//        },
        ...
        State {
            ...
            PropertyChanges { target: buttonText; text: checked ? button.textChecked : button.textUnchecked; }
        },
        State {
