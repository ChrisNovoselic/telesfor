...
//            checked: enabledFixedPSC ()
            ...
            onClicked: {
                console.debug ("btnFixedPSC::onClicked (), checked =", checked)
                sgnResetPSC ()
...
//                                                        '"type":"' + 'patient' + '",' +
//                                                        '"birthDate":"' + dtBirstDay.toDateString () + '",' +
//                                                        '"diagnosis":"' + 'Диагнозе...диагнозе...диагнозе...диагнозе...диагнозе...диагнозе...диагнозе...диагнозе...диагнозе...диагнозе...диагнозе...диагнозе...диагнозе' + '",' +
//                                                        '"height":"' + 124 + '",' +
//                                                        '"weight":"' + 77 +
//                                                        '"}'))
