...
public:
    HOgreWidget (QWidget *, Ogre::Root *, HSynchCoordinates *, QDeclarativeItem *, QString);
    ~HOgreWidget();
...
public slots:
    ...
    void onCheckedLatticeLine (int, bool, QColor);
...
//    Ogre::SceneNode *m_ProjectorPosterNode; //ПРОЕКТор для управлениЯ текстуроЙ оБЪектА 'Wall'
    ...
    short getIndexMarkerPSC (void);

    short m_shCountEmptyArrayMarkers;
    short m_shCountSetArrayMarkers;
//    bool m_bFixedPSC;
    ...
    QDeclarativeItem *m_parentQMLItem;
