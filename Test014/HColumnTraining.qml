...
//        sgnTrainingStatisticActivate ()
    ...
    function enabledParam () {
        var btnPatientTask = columnPatientTask.getButtonTaskChecked (), bRes = false
    ...
    Connections {
        ...
        onSgnSetPatientTask: {
            var taskJSON = JSON.parse (task), putData = ""
            console.debug ("HColumnTraining::onSgnSetPatientTask:task =", task)
//            console.debug ("rectangleForm::onSgnSetPatientTask = ", task, taskJSON ["speed"] [sliderCurrentTrainingStage.toString ()] ["value"])
//            console.debug ("HColumnTraining::onSgnSetPatientTask =", taskJSON ["speed"] [sliderCurrentTrainingStage.toString ()] ["value"])

            function paramChangeValue (name, obj, val) {
                console.debug ("HColumnTraining::onSgnSetPatientTask:paramChangeValue =", name, obj, val)
                if (! (obj.val === val)) {
                    obj.val = val
                }
                else
...
//                        console.debug ("HColumnTraining::onSgnSetPatientTask:paramChangeValue =", "TIME", sliderCurrentTime)
//                    }
//                    else {
//                        if (name.indexOf ("distance") > -1) {
//                            putData += makePutData (name, sliderCurrentTrainingStage - 1, sliderCurrentDistance) + ','
//                            console.debug ("HColumnTraining::onSgnSetPatientTask:paramChangeValue =", "DISTANCE", sliderCurrentDistance)
//                        }
//                        else {
//                            putData += makePutData (name, sliderCurrentTrainingStage, val) + ','
//                            console.debug ("HColumnTraining::onSgnSetPatientTask:paramChangeValue =", name, val)
//                        }
//                    }
                }
                else
            ...
            console.debug ("HColumnTraining::onSgnSetPatientTask (sliderCurrentTrainingStage, sliderCurrentTime, sliderCurrentDistance)", sliderCurrentTrainingStage, sliderCurrentTime, sliderCurrentDistance)

//            if (taskJSON ["_id"].indexOf ("defaultTask") > -1) {
                paramChangeValue ("tilt", paramTrackTilt, taskJSON ["tilt"] ["value"] [sliderCurrentTrainingStage.toString ()])
                paramChangeValue ("distance", paramTrainingDistance, taskJSON ["distance"] ["value"] [sliderCurrentTrainingStage.toString ()])
                paramChangeValue ("time", paramTrainingTime, taskJSON ["time"] ["value"] [sliderCurrentTrainingStage.toString ()])
                paramChangeValue ("stepsLength", paramStepsLength, taskJSON ["stepsLength"] ["value"] [sliderCurrentTrainingStage.toString ()])
                paramChangeValue ("speed", paramTrackSpeed, taskJSON ["speed"] ["value"] [sliderCurrentTrainingStage.toString ()])
//            }
//            else {
//                paramChangeValue ("tilt", paramTrackTilt, taskJSON ["tilt"] [sliderCurrentTrainingStage.toString ()] ["value"])
//                paramChangeValue ("distance", paramTrainingDistance, taskJSON ["distance"] [sliderCurrentTrainingStage.toString ()] ["value"])
//                paramChangeValue ("time", paramTrainingTime, taskJSON ["time"] [sliderCurrentTrainingStage.toString ()] ["value"])
//                paramChangeValue ("stepsLength", paramStepsLength, taskJSON ["stepsLength"] [sliderCurrentTrainingStage.toString ()] ["value"])
//                paramChangeValue ("speed", paramTrackSpeed, taskJSON ["speed"] [sliderCurrentTrainingStage.toString ()] ["value"])
//            }
...
//                putData = JSON.parse ('{"phases":{"' + (sliderCurrentTrainingStage - 1).toString () + '":{}},{"' + (sliderCurrentTrainingStage - 0).toString () + '":{}}}')
////                putData ['phases'] [(sliderCurrentTrainingStage - 1).toString ()] ['type'] = 'idle'
////                putData ['phases'] [(sliderCurrentTrainingStage - 1).toString ()] ['timeStamp'] = dtStamp.toTimeString ()
////                putData ['phases'] [(sliderCurrentTrainingStage - 1).toString ()] ['speed'] = '666'
////                putData ['phases'] [(sliderCurrentTrainingStage - 1).toString ()] ['tilt'] = '666'
//                putData ['phases'] [(sliderCurrentTrainingStage - 1).toString ()] ['time'] = '667'
//                putData ['phases'] [(sliderCurrentTrainingStage - 1).toString ()] ['distance'] = '667'
////                putData ['phases'] [(sliderCurrentTrainingStage - 1).toString ()] ['stepsLength'] = '666'

//                putData ['phases'] [(sliderCurrentTrainingStage - 0).toString ()] ['type'] = 'work'
//                putData ['phases'] [(sliderCurrentTrainingStage - 0).toString ()] ['timeStamp'] = dtStamp.toTimeString ()
//                putData ['phases'] [(sliderCurrentTrainingStage - 0).toString ()] ['speed'] = '667'
//                putData ['phases'] [(sliderCurrentTrainingStage - 0).toString ()] ['tilt'] = '667'
//                putData ['phases'] [(sliderCurrentTrainingStage - 0).toString ()] ['time'] = '0'
//                putData ['phases'] [(sliderCurrentTrainingStage - 0).toString ()] ['distance'] = '0'
//                putData ['phases'] [(sliderCurrentTrainingStage - 0).toString ()] ['stepsLength'] = '667'
...
//                                    '"distance":"666"' + ',' +
                ...
                console.debug ("HColumnTraining::onSgnSetPatientTask putData =", JSON.stringify (putData))
...
//                    posPopupWindow (paramTrainingTime, textRowTrainingTimeDescription.text)
    ...
    Row {
        ...
        TextField {
            ...
            text: paramTrainingDistance.val
            font {
                pixelSize: Math.round (height * ratioHeightTextField)
            }
            horizontalalignment: TextInput.AlignHCenter
